...
<table id="charge__content_list" class="mgb-24">
    <thead class="bdt-1-solid-g4 bdb-1-solid-g4">
        <tr>
            <th class="bg-g2 pdvt-8 text-weight-medium text-color-g12 text-size-xsmall">사용일</th>
            <th class="bg-g2 pdvt-8 text-weight-medium text-color-g12 text-size-xsmall">구분</th>
    ...
    <tbody>
        <?php if(pave_is_array($pay_list)){ ?>
            ...
            <tr class="bdb-1-solid-g4 text-align-center">
                <td class="text-weight-regular text-color-g12 text-size-xsmall pdvt-12"><?=Converter::display_time($pay["pay_insert_dt"])?></td>
                <td class="text-weight-regular text-color-g12 text-size-xsmall pdvt-12"><?=$pay["pay_type_text"]?></td>
        ...
        <?php }else{ ?>
            <tr class="bdb-1-solid-g4 text-align-center">
                <td colspan="5" class="charge__content_empty">사용내역이 없습니다.</td>
            </tr>
        <?php }?>
    </tbody>
</table>
