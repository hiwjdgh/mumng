...
?>
<div id="modal" class="modals commerce_calc_modal" data-target="commerce_calc_modal">
    <div id="modal__box" class="modal__box--620">
        <div id="modal__header" class="modal__header--lg">
            <h2 id="modal__header-title"><?=$title?></h2>
            <button type="button" id="modal__header-close-button" class="modal-close-button" data-anchor="commerce_calc_modal"><span class="icon-x icon-20"></span><span class="skip">닫기</span></button>
        </div>
            ...
            <div class="commerce_calc__box">
                <div class="commerce_calc__hold">
                    ...
                    <div class="commerce_calc__hold-box">
                        <span class="commerce_calc__hold-exp"><?=Converter::display_number($profit_overview["hold_exp"])?></span>
                        <span class="commerce_calc__hold-text2">EXP</span>
                    </div>
                </div>
                <form class="user-form commerce_calc__form" novalidate autocomplete="off">
                    ...
                    <div class="commerce_calc__withdraw">
                        ...
                        <div id="commerce__calc-withdrawal-exp" class="input-box input-box-t5">
                            <input type="number" name="calc_exp" id="calc_exp" class="input-box-t5__input" min="1000" step="100" value="<?=$profit_overview["hold_exp"]?>" title="출금할 EXP" placeholder="출금할 EXP(숫자만 입력)" required>
                        </div>
                    </div>
                    ...
                    <div class="commerce_calc__deposit">
                        ...
                        <div class="commerce_calc__deposit-bank select-box">
                            <label for="calc_bank_name" class="select-box__label">은행</label>
                            <select name="calc_bank_name" id="calc_bank_name" class="select-box__select" title="은행" required>
                        ...
                        <div class="commerce_calc__deposit-account-number input-box-t2">
                            ...
                            <input type="text" name="calc_bank_number" id="calc_bank_number" class="input-box-t2__input" value="<?=$pave_user["user_bank"]["user_bank_number"]?>" title="계좌번호" placeholder="계좌번호(숫자만 입력)" required>
                        </div>

                        <div class="commerce_calc__deposit-owner input-box-t2">
                            <label for="calc_bank_owner" class="input-box-t2__label">예금주</label>
                            <input type="text" name="calc_bank_owner" id="calc_bank_owner" class="input-box-t2__input" value="<?=$pave_user["user_bank"]["user_bank_owner"]?>" title="예금주" placeholder="예금주" required>
                        </div>
                    </div>
                    ...
                    <div class="commerce_calc__bsns">
                        ...
                        <div class="commerce_calc__bsns-owner input-box-t2" style="display:<?=$pave_user["user_bsns_state"] ? "" : "none" ?>;">
                            ...
                            <input type="text" name="calc_bsns_owner" id="calc_bsns_owner" class="input-box-t2__input" value="<?=$pave_user["user_bsns"]["user_bsns_owner"]?>" title="대표자명" placeholder="대표자명">
                        </div>
                        ...
                        <div class="commerce_calc__bsns-name input-box-t2" style="display:<?=$pave_user["user_bsns_state"] ? "" : "none" ?>;">
                            ...
                            <input type="text" name="calc_bsns_name" id="calc_bsns_name" class="input-box-t2__input" value="<?=$pave_user["user_bsns"]["user_bsns_name"]?>" title="상호명" placeholder="상호명">
                        </div>
                        <div class="commerce_calc__bsns-number input-box-t2" style="display:<?=$pave_user["user_bsns_state"] ? "" : "none" ?>;">
                            ...
                            <input type="text" name="calc_bsns_number" id="calc_bsns_number" class="input-box-t2__input" value="<?=$pave_user["user_bsns"]["user_bsns_number"]?>" title="사업자등록번호" placeholder="사업자등록번호(숫자만 입력)">
                        </div>
                    </div>
