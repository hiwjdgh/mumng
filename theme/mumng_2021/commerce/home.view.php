    ...
    <div class="commerce__row">
        ...
        <div class="commerce__col">
            <div class="commerce__card">
                ...
                <div class="commerce__card-content">
                    <div class="commerce__row">
                        <div class="commerce__col flex-align-item-center flex-justify-content-space-between text-size-small text-color-g12 text-weight-regular">
                            <span>작품</span>
    ...
    <div class="commerce__row">
        <div class="commerce__col">
            <div class="commerce__home-empty">
                <img src="<?=get_url(PAVE_IMG_URL,"img_empty_commerce_640px.png")?>" alt="커머스없음 이미지" width="500" height="500" usemap="#author" class="commerce__home-empty-img">
                <map name="author">
                <area shape="poly" coords="144,354,222,394,216,408,138,365" alt="jearth._.k" href="https://www.instagram.com/jearth._.k" target="_blank">
                </map>
...
$(document).ready(function() {
    $(".commerce__home-empty-text2").on("click", function(){
        modals.load("commerce_reg", "커머스 작가등록", {});
    });
    $(".commerce__home-request-content-list .data-table__body-row").on("click", function(){
