...
<div id="setting">
    ...
    <div id="setting__content" class="mxw-316">
        ...
        <form id="pwd_change_form" novalidate autocomplete="off">
            ...
            <fieldset id="pwd_change_step2" class="flex flex-column mxw-316" style="display: none;">
