...
<div class="upload-epsd">
    ...
    <form class="upload-epsd__form" enctype="multipart/form-data" novalidate autocomplete="off">
        ...
        <input type="hidden" name="epsd_cate" id="epsd_cate" value="notice">
        ...
        <legend class="skip">공지정보</legend>
        <fieldset class="upload-epsd__fieldset">
        
            <?php if($action == "update" && $work["is_own"]){ ?>
            <button type="button" class="upload-epsd-submit-button upload-epsd-delete-button upload-epsd__delete-button">공지 삭제하기
        ...
        <fieldset class="upload-epsd__fieldset">
            <div class="upload-epsd__info">
                <h3 class="upload-epsd__info-label">공지명</h3>
                <div class="upload-epsd__info-box">
                    ...
                    <div class="upload-epsd__info-img file-epsd <?=$epsd["epsd_img"] ? "edit" : ""?>">
                        <label for="epsd_img" class="file-epsd__box">
                            ...
                            <span class="file-epsd__box-text">공지 이미지</span>
                            <span class="file-epsd__box-text2">(500px X 500px)</span>
                            <img src="<?=$epsd["epsd_img"]?>" alt="공지 이미지" id="epsd__img-preview" class="file-epsd__img">
                        </label>
                    </div>

                    <div class="upload-epsd__info-name input-box-t4">
                        <?php if($action == "create"){ ?>
                        <input type="text" name="epsd_name" id="epsd_name" class="input-box-t4__input" value="공지" minlength="<?=$epsd_config["epsd_name_min_len"]?>" maxlength="<?=$epsd_config["epsd_name_max_len"]?>" placeholder="공지명" required>
                        <?php }else{ ?>
                        <input type="text" name="epsd_name" id="epsd_name" class="input-box-t4__input" value="<?=$epsd["epsd_name"]?>" minlength="<?=$epsd_config["epsd_name_min_len"]?>" maxlength="<?=$epsd_config["epsd_name_max_len"]?>" placeholder="공지명" required>
                        <?php } ?>
                    </div>
                </div>
            </div>
