...
<?php foreach ($work_list as $i => $work) { ?>
    ...
    <a href="<?=get_url(PAVE_SETTING_URL, "account/content")?>" class="webtoon-item-adult">
        <img src="<?=get_url(PAVE_IMG_URL, "img_content_block_290px.png")?>" alt="성인물 제한 이미지" width="290" height="360" class="webtoon-item-adult__img">
    </a>
    <?php }else{ ?>
...
<?php }else{ ?>
    ...
    <li class="webtoon-item-empty">
        <img src="<?=get_url(PAVE_IMG_URL,"img_empty_default_640px.png")?>" alt="작품없음 이미지" width="360" height="360" usemap="#author" class="webtoon-item-empty-img">
        <map name="author">
        <area shape="rect" coords="62,303,134,323" alt="jearth._.k" href="https://www.instagram.com/jearth._.k" target="_blank">
        </map>
    </li>
    <?php } ?>
<?php } ?>