...
?>
<div id="modal" class="modals work_epsd_caution_modal" data-target="work_epsd_caution_modal">
    <div id="modal__box" class="modal__box--380">
        ...
        <div id="modal__footer">
           <button type="button" class="work_epsd_caution__button button-s1 button-t1" data-id="<?=$work_id?>" data-epsd="<?=$epsd_id?>">확인했습니다</button>
        </div>
    </div>
</div>