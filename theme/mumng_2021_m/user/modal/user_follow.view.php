    ...
    <div id="modal__box" class="modal__box--normal">
            ...
            <div id="modal__header-tab">
                <ul id="modal__header-tab-list">
                    <li class="modal__header-tab-item <?=$type == "follower" ? "current" : ""?>">
                        <button type="button" class="follower-button" data-user="<?=$user_code?>">팔로워</button>
                    </li>
                    <li class="modal__header-tab-item <?=$type == "following" ? "current" : ""?>">
                        <button type="button" class="following-button" data-user="<?=$user_code?>">팔로잉</button>
                    </li>
                </ul>
            </div>
        ...
        <div id="modal__content">
            <div class="user_follow__box">
                ...
                <ul class="user_follow__list" onscroll="follow_obj.get_user_follow_list();">
                </ul>
            </div>
        </div>
