...
<section class="plan">
    <div class="plan__container">
        <div class="plan__box1">
            <div class="plan__box1-inner-box">
                <div class="plan__box1-img-box">
                    <img src="<?=get_url(PAVE_IMG_URL,"img_empty_plan_640px.png")?>" alt="플랜 이미지" width="320" height="320" usemap="#author" class="plan__box1-img">
                    <map name="author">
                    <area shape="rect" coords="231,244,295,261" alt="jearth._.k" href="https://www.instagram.com/jearth._.k" target="_blank">
                    </map>
                </div>
        ...
        <div class="plan__box3">
            <div>
                <img src="<?=get_url(PAVE_IMG_URL,"img_empty_default2_640px.png")?>" alt="커머스 이미지" width="320" height="320" usemap="#author3" class="plan__box3-img">
                <map name="author3">
                <area shape="rect" coords="200,220,220,280" alt="jearth._.k" href="https://www.instagram.com/jearth._.k" target="_blank">
                </map>
            </div>
