...
?>
<div class="setting__notify" style="display: none;" data-target="">
...
<div class="setting__notify" style="display: none;" data-target="#work">
...
<div class="setting__notify" style="display: none;" data-target="#subscribe">
...
<div class="setting__notify" style="display: none;" data-target="#pay">
...
<div class="setting__notify" style="display: none;" data-target="#charge">
...
<div class="setting__notify" style="display: none;" data-target="#commerce">
...
<div class="setting__notify" style="display: none;" data-target="#login">
...
<div class="setting__notify" style="display: none;" data-target="#mumng">
...
function change_tab(){
    ...
    $(".setting__notify").hide().filter("[data-target='"+target+"']").show();
}
$(function(){
    change_tab();
