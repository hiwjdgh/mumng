...
<div class="setting__profile">
    <form id="profile__form" class="setting__profile-form" enctype="multipart/form-data" novalidate autocomplete="off">
        ...
        <fieldset class="flex flex-column">
            ...
            <div class="flex flex-column mgb-32">
                <h3 class="text-weight-medium text-color-g10 text-size-normal mgb-12">프로필이미지</h3>

                <div class="file-profile edit flex-align-self-center">
            ...
            <div class="flex flex-column mgb-60">
                ...
                <ul id="user__sns-list" class="flex flex-column gap-row-8">
