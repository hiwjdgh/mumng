...
if(!$work["work_id"]){
    die(return_json(null, "200", "해당 의견을 찾을 수 없습니다."));
}
...
$cmt_obj->set_cmt_parent_id($cmt_id);
$cmt_obj->set_cmt_page($page);
$reply_list = $cmt_obj->get_cmt_list();
...
ob_start();
$theme_path = $pave_theme["thm_path"]."/reply_list.view.php";
