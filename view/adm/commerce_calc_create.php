...
$calc_real_price = pave_input_sanitize($calc_real_price);
$calc_fee_price = pave_input_sanitize($calc_fee_price);
$calc_tax_price = pave_input_sanitize($calc_tax_price);
$calc_vat_price = pave_input_sanitize($calc_vat_price);
...
//정산 EXP 검사
if($msg = sanitize_reg_user_calc_exp($calc_exp, false)){
    alert($msg);
}
